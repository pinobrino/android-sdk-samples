...
public class MainActivity extends Activity implements WaveGestureListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		waveGestureHandler = new WaveGestureHandler(this.getApplicationContext());
		waveGestureHandler.setUsageTrackingDetails("developer@snapback", "Snap4Magic");
		
		//ProximitySensorAdapter proximitySensorAdapter = new ProximitySensorAdapter(waveGestureHandler, this);
		//AmbientLightSensorAdapter ambientLightSensorAdapter = new AmbientLightSensorAdapter(waveGestureHandler, this);
		//waveGestureHandler.setSensorAdapters(proximitySensorAdapter, ambientLightSensorAdapter);
		
		SnapSensorAdapter snap = new SnapSensorAdapter(waveGestureHandler, this);
		waveGestureHandler.setSensorAdapters(snap);
...
//		int gpsa = GooglePlayServicesUtil.isGooglePlayServicesAvailable(this);
//		
//		if(gpsa != ConnectionResult.SUCCESS) {
//			GooglePlayServicesUtil.getErrorDialog(gpsa, this, Activity.RESULT_CANCELED).show();
//		}
//		else {
